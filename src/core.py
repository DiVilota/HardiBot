...
# Función auxiliar segura para la calculadora
def operacion_segura(operacion: str):
    return eval(operacion, {"__builtins__": None}, {})
...
herramientas = [buscar_catalogo, calcular_presupuesto, agregar_al_carrito, ver_carrito]
